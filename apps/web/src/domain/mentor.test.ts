...
const context: MentorContext = {
  ...
  tasks: [
    { id: 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', workspaceId: 'local-personal-workspace', createdBy: 'u', title: 'Draft richer reply engine', description: '', projectId: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', ideaId: null, columnId: 'in_progress', sortOrder: 1, priority: 'high', completionPct: 20, createdAt: now, updatedAt: now, completedAt: null, version: 1, clientId: 'c', deviceId: 'd', isDeleted: false },
    { id: 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', workspaceId: 'local-personal-workspace', createdBy: 'u', title: 'Polish mentor tests', description: '', projectId: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', ideaId: null, columnId: 'review', sortOrder: 2, priority: 'medium', completionPct: 80, createdAt: now, updatedAt: now, completedAt: null, version: 1, clientId: 'c', deviceId: 'd', isDeleted: false },
  ],
  notes: [
